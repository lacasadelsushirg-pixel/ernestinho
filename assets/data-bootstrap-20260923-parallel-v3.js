...
(async()=>{
 ...
 const x=document.createElement('script');x.src='/assets/app-runtime-20260923-validated-v2.js?v=2';x.onerror=()=>console.error('EC app load failed');document.body.appendChild(x);
