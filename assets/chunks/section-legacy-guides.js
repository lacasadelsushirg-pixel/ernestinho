...
section === 'guia_anterior' && (React.createElement("section", { className: "py-12 bg-slate-50" },
                React.createElement("div", { className: "max-w-7xl mx-auto px-4 sm:px-6" },
                    ...
                    React.createElement("div", { className: "grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6" }, [
                        { titulo: 'Primer viaje a Río', desc: 'Lo indispensable si es tu primera vez en la ciudad.', icon: '✈️', art: (window.ARTICULOS_CONSEJOS||[])[0] },
                        { titulo: 'Electricidad y adaptadores', desc: 'Voltaje (110V/220V), enchufes tipo N y adaptadores.', icon: '🔌', art: (window.ARTICULOS_CONSEJOS||[])[1] },
                        { titulo: 'Preparando las maletas', desc: 'Clima tropical, pronósticos, ropa recomendada y días de lluvia.', icon: '🧳', art: (window.ARTICULOS_CONSEJOS||[])[2] },
                        { titulo: 'Vacunas', desc: 'Información sobre fiebre amarilla, requisitos de salud y prevención.', icon: '💉', art: (window.ARTICULOS_CONSEJOS||[])[3] },
                        { titulo: 'Visado y aduana', desc: 'Exención de visas (90 días), pasaporte y regulaciones de aduana.', icon: '📄', art: (window.ARTICULOS_CONSEJOS||[])[4] },
...
section === 'consejos_anterior' && (React.createElement("section", { className: "py-12 bg-slate-50" },
                React.createElement("div", { className: "max-w-7xl mx-auto px-4 sm:px-6" },
                    ...
                    React.createElement("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-8" }, (window.ARTICULOS_CONSEJOS||[]).map((art) => (React.createElement("div", { key: art.id, className: "bg-white rounded-3xl overflow-hidden  border border-slate-100 flex flex-col sm:flex-row" },
