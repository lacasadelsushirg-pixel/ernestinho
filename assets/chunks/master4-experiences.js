    ...
    return React.createElement("div", { className: "min-h-screen bg-[#f7f7f4] pb-24" },
        React.createElement("header", { className: "max-w-7xl mx-auto px-4 sm:px-6 pt-6" },
            ...
            React.createElement("div", { className: "mt-5 rounded-[2rem] bg-slate-950 text-white p-7 sm:p-10" },
                ...
                React.createElement("h1", { className: "text-4xl sm:text-6xl font-black mt-2" }, T("Elige primero qué tipo de experiencia quieres vivir.")),
                React.createElement("p", { className: "text-sm text-white/70 mt-4 max-w-3xl" }, T("Tours propios, operadores locales y socios oficiales claramente identificados. Ahora están agrupados para que no tengas que recorrer una lista interminable.")))),
