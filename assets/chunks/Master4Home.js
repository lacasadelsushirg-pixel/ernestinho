...
function Master4Home({ go, onReserve, lang = 'es' }) {
    ...
    const exploreCards = [
        { route:'guia', icon:'✓', es:['Guía para mi viaje','Todo antes y durante tu viaje'], pt:['Guia para minha viagem','Tudo antes e durante a viagem'], en:['Trip guide','Everything before and during your trip'], img:'https://res.cloudinary.com/tdez3h4t/image/upload/v1789918904/PORTADA_HOME_NUEVO_7.png' },
        { route:'master4_transportes', icon:'→', es:['Transportes','Muévete por la ciudad'], pt:['Transportes','Mova-se pela cidade'], en:['Transport','Get around the city'], img:'https://res.cloudinary.com/tdez3h4t/image/upload/v1789918904/PORTADA_HOME_NUEVO_8.png' },
        ...
        { route:'cafe', icon:'☕', es:['Café Río','Cafés y pausas cariocas'], pt:['Café Rio','Cafés e pausas cariocas'], en:['Café Rio','Coffee and Rio breaks'], img:'https://res.cloudinary.com/tdez3h4t/image/upload/v1789918904/PORTADA_HOME_NUEVO_14.png' },
