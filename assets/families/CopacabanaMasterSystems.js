                ...
                React.createElement("div", { className: "mt-6 rounded-[1.8rem] bg-[#102424] border border-white/10 overflow-hidden " },
                    React.createElement("div", { className: "grid lg:grid-cols-[minmax(0,1fr)_minmax(0,1.15fr)]" },
                        ...
                        React.createElement("div", { className: "p-5 sm:p-8" },
                            ...
                            active === 'sos' && React.createElement("div", { className: "mt-7 grid md:grid-cols-2 gap-3" }, COPA_SOS_GUIDES.map(g => React.createElement("article", { key: g.title, className: "rounded-2xl bg-red-950/30 border border-red-300/10 p-4" }, React.createElement("strong", { className: "text-sm" }, g.title), React.createElement("ol", { className: "mt-2 text-xs text-white/60 space-y-1" }, g.steps.map((s, i) => React.createElement("li", { key: s }, `${i + 1}. ${s}`))))))))))));
}
