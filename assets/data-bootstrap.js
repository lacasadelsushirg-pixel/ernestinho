...
(async()=>{
 ...
 const x=document.createElement('script');x.src='/assets/app.js?v=20260923-modular-fix1';x.onerror=()=>console.error('EC app load failed');document.body.appendChild(x);
